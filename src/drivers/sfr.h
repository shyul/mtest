...
#define rWDT_MR					(*(volatile U32 *)(0xFFFFFD44))
...
#define rSMC_SETUP(cs)	(*(volatile U32 *)(0xFFFFE800+cs*0x10+0x00)) // SMC Setup Register Read-write 0x01010101
#define rSMC_PULSE(cs)	(*(volatile U32 *)(0xFFFFE800+cs*0x10+0x04)) // SMC Pulse Register Read-write 0x01010101
#define rSMC_CYCLE(cs)	(*(volatile U32 *)(0xFFFFE800+cs*0x10+0x08)) // SMC Cycle Register Read-write 0x00030003
#define rSMC_MODE(cs)		(*(volatile U32 *)(0xFFFFE800+cs*0x10+0x0C)) // SMC Mode Register Read-write 0x10001000
#define rSMC_DELAY1			(*(volatile U32 *)(0xFFFFE800+0xC0)) // SMC Delay on I/O Read-write 0x00000000
#define rSMC_DELAY2			(*(volatile U32 *)(0xFFFFE800+0xC4)) // SMC Delay on I/O Read-write 0x00000000
#define rSMC_DELAY3			(*(volatile U32 *)(0xFFFFE800+0xC8)) // SMC Delay on I/O Read-write 0x00000000
#define rSMC_DELAY4			(*(volatile U32 *)(0xFFFFE800+0xCC)) // SMC Delay on I/O Read-write 0x00000000
#define rSMC_DELAY5			(*(volatile U32 *)(0xFFFFE800+0xD0)) // SMC Delay on I/O Read-write 0x00000000
#define rSMC_DELAY6			(*(volatile U32 *)(0xFFFFE800+0xD4)) // SMC Delay on I/O Read-write 0x00000000
#define rSMC_DELAY7			(*(volatile U32 *)(0xFFFFE800+0xD8)) // SMC Delay on I/O Read-write 0x00000000
#define rSMC_DELAY8			(*(volatile U32 *)(0xFFFFE800+0xDC)) // SMC Delay on I/O Read-write 0x00000000
...
#define rRTC_CR					(*(volatile U32 *)(0xFFFFFDB0)) // Control Register  Read-write 0x0
#define rRTC_MR					(*(volatile U32 *)(0xFFFFFDB4)) // Mode Register  Read-write 0x0
#define rRTC_TIMR				(*(volatile U32 *)(0xFFFFFDB8)) // Time Register  Read-write 0x0
#define rRTC_CALR				(*(volatile U32 *)(0xFFFFFDBC)) // Calendar Register  Read-write 0x01819819
#define rRTC_TIMALR			(*(volatile U32 *)(0xFFFFFDC0)) // Time Alarm Register  Read-write 0x0
#define rRTC_CALALR			(*(volatile U32 *)(0xFFFFFDC4)) // Calendar Alarm Register  Read-write 0x01010000
#define rRTC_SR					(*(volatile U32 *)(0xFFFFFDC8)) // Status Register  Read-only 0x0
#define rRTC_SCCR				(*(volatile U32 *)(0xFFFFFDCC)) // Status Clear Command Register  Write-only ---
#define rRTC_IER				(*(volatile U32 *)(0xFFFFFDD0)) // Interrupt Enable Register  Write-only ---
#define rRTC_IDR				(*(volatile U32 *)(0xFFFFFDD4)) // Interrupt Disable Register  Write-only ---
#define rRTC_IMR				(*(volatile U32 *)(0xFFFFFDD8)) // Interrupt Mask Register  Read-only 0x0
#define rRTC_VER				(*(volatile U32 *)(0xFFFFFDDC)) // Valid Entry Register Read-only 0x0
...
#define rTWI_CR					(*(volatile U32 *)(0xFFF84000)) // Control Register  Write-only N / A
#define rTWI_MMR				(*(volatile U32 *)(0xFFF84004)) // Master Mode Register Read-write 0x00000000
#define rTWI_SMR				(*(volatile U32 *)(0xFFF84008)) // Slave Mode Register Read-write 0x00000000
#define rTWI_IADR				(*(volatile U32 *)(0xFFF8400C)) // Internal Address Register Read-write 0x00000000
#define rTWI_CWGR				(*(volatile U32 *)(0xFFF84010)) // Clock Waveform Generator Register Read-write 0x00000000
#define rTWI_SR					(*(volatile U32 *)(0xFFF84020)) // Status Register Read-only 0x0000F009
#define rTWI_IER				(*(volatile U32 *)(0xFFF84024)) // Interrupt Enable Register Write-only N / A
#define rTWI_IDR				(*(volatile U32 *)(0xFFF84028)) // Interrupt Disable Register Write-only N / A
#define rTWI_IMR				(*(volatile U32 *)(0xFFF8402C)) // Interrupt Mask Register Read-only 0x00000000
...
#define rTC0_CCR(ch)		(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x00))		// Channel Control Register  Write-only 每
#define rTC0_CMR(ch)		(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x04))		// Channel Mode Register  Read-write 0
#define rTC0_CV(ch)			(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x10))		// Counter Value Read-only 0
#define rTC0_RA(ch)			(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x14))		// Register A Read-write (2) 0
#define rTC0_RB(ch)			(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x18))		// Register B Read-write (2) 0
#define rTC0_RC(ch)			(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x1C))		// Register C Read-write 0
#define rTC0_SR(ch)			(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x20))		// Status Register Read-only 0
#define rTC0_IER(ch)		(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x24))		// Interrupt Enable Register Write-only 每
#define rTC0_IDR(ch)		(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x28)) 		// Interrupt Disable Register Write-only 每
#define rTC0_IMR(ch)		(*(volatile U32 *)(0xFFF7C000+ch*0x40+0x2C)) 		// Interrupt Mask Register Read-only 0
#define rTC0_BCR				(*(volatile U32 *)(0xFFF7C0C0)) 								// Block Control Register Write-only 每
#define rTC0_BMR				(*(volatile U32 *)(0xFFF7C0C4)) 								// Block Mode Register Read-write 0
